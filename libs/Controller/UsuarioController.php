...
class UsuarioController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdUsuario,Username,Password,Nombre,Apellido'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$usuario->Apellido = $this->SafeGetVal($json, 'apellido');
	...
	public function Update()
	{
		try
		{
			...
			$usuario->Apellido = $this->SafeGetVal($json, 'apellido', $usuario->Apellido);
