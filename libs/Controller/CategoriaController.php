...
class CategoriaController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('IdCategoria,Nombre'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			// $categoria->IdCategoria = $this->SafeGetVal($json, 'idCategoria');

			$categoria->Nombre = $this->SafeGetVal($json, 'nombre');
	...
	public function Update()
	{
		try
		{
			...
			// $categoria->IdCategoria = $this->SafeGetVal($json, 'idCategoria', $categoria->IdCategoria);

			$categoria->Nombre = $this->SafeGetVal($json, 'nombre', $categoria->Nombre);
