...
require_once("DAO/TestimonioCriteriaDAO.php");

/**
 * The TestimonioCriteria class extends TestimonioDAOCriteria and is used
 ...
 * @version 1.0
 */
class TestimonioCriteria extends TestimonioCriteriaDAO
{
