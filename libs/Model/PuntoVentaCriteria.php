...
require_once("DAO/PuntoVentaCriteriaDAO.php");

/**
 * The PuntoVentaCriteria class extends PuntoVentaDAOCriteria and is used
 ...
 * @version 1.0
 */
class PuntoVentaCriteria extends PuntoVentaCriteriaDAO
{
