...
require_once("DAO/SliderTaCriteriaDAO.php");

/**
 * The SliderTaCriteria class extends SliderTaDAOCriteria and is used
 ...
 * @version 1.0
 */
class SliderTaCriteria extends SliderTaCriteriaDAO
{
