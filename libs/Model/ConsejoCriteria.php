...
require_once("DAO/ConsejoCriteriaDAO.php");

/**
 * The ConsejoCriteria class extends ConsejoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConsejoCriteria extends ConsejoCriteriaDAO
{
