...
<h1>
		...
		<form class="form-horizontal" onsubmit="return false;">
			<fieldset>
				...
				<div id="textoInputContainer" class="control-group">
					<label class="control-label" for="texto">Texto (HTML)</label>
					<div class="controls inline-inputs">
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<span id="confirmDeleteTestimonioContainer" class="hide">
							<button id="cancelDeleteTestimonioButton" class="btn btn-mini">Cancelar</button>
							<button id="confirmDeleteTestimonioButton" class="btn btn-mini btn-danger">Confirmar</button>
						</span>
					</div>
				</div>
			</fieldset>
	...
	<div class="modal hide fade" id="testimonioDetailDialog">
		<div class="modal-header">
			...
			<h3>
				<i class="icon-edit"></i> Editar Testimonio
		...
		<div class="modal-footer">
			...
			<button id="saveTestimonioButton" class="btn btn-primary">Guardar</button>
		</div>
	</div>
	...
	<p id="newButtonContainer" class="buttonContainer">
		<button id="newTestimonioButton" class="btn btn-primary">Agregar Testimonio</button>
	</p>
