...
GlobalConfig::$CONNECTION_SETTING->DBName = "annadsar_admin";
...
/** the root url of the application with trailing slash, for example http://localhost/anna de santis/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'admin/';
