...
class UploadHandler
{
    ...
    function __construct($categoria,$options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/files/'.$categoria.'/',
            'base_dir' =>$this->get_full_url().'/index.php?categoria='.$categoria.'',
            'upload_url' => $this->get_full_url().'/files/'.$categoria.'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
